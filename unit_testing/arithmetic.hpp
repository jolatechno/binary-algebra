...
void test_transpose(const reference_arithmetic ref, const Matrice& mat) {
...
void test_multiplication(const reference_arithmetic ref, const Matrice& mat1, const Matrice& mat2) {
  Matrice stupid_product = ref.multiplication(mat1, mat2);

  assert(ref.equal(mat1 * mat2, stupid_product));
}

void test_multiplication(const reference_arithmetic ref, const Matrice& mat, const Vector& vect) {
  Vector stupid_product = ref.multiplication(mat, vect);

  assert(ref.equal(mat * vect, stupid_product));
}

void test_multiplication(const reference_arithmetic ref, const Vector& vect1, const Vector& vect2) {
...
void test_addition(const reference_arithmetic ref, const Matrice& mat1, const Matrice& mat2) {
  Matrice stupid_add = ref.addition(mat1, mat2);

  assert(ref.equal(mat1 ^ mat2, stupid_add));
}

void test_addition(const reference_arithmetic ref, const Matrice& mat, bool bit) {
  Matrice stupid_add = ref.addition(mat, bit);

  assert(ref.equal(mat ^ bit, stupid_add));
}

void test_addition(const reference_arithmetic ref, const Vector& vect1, const Vector& vect2) {
  Vector stupid_add = ref.addition(vect1, vect2);

  assert(ref.equal(vect1 ^ vect2, stupid_add));
}
void test_addition(const reference_arithmetic ref, const Vector& vect, bool bit) {
...
void test_bitwise_multiplication(const reference_arithmetic ref, const Matrice& mat1, const Matrice& mat2) {
  Matrice stupid_mul = ref.bitwise_multiplication(mat1, mat2);

  assert(ref.equal(mat1 & mat2, stupid_mul));
}

void test_bitwise_multiplication(const reference_arithmetic ref, const Matrice& mat, bool bit) {
  Matrice stupid_mul = ref.bitwise_multiplication(mat, bit);

  assert(ref.equal(mat & bit, stupid_mul));
}

void test_bitwise_multiplication(const reference_arithmetic ref, const Vector& vect1, const Vector& vect2) {
  Vector stupid_mul = ref.bitwise_multiplication(vect1, vect2);

  assert(ref.equal(vect1 & vect2, stupid_mul));
}
void test_bitwise_multiplication(const reference_arithmetic ref, const Vector& vect, bool bit) {
...
void test_negation(const reference_arithmetic ref, const Matrice& mat) {
  Matrice stupid_negated = ref.negate(mat);

  assert(ref.equal(~mat, stupid_negated));
}

void test_negation(const reference_arithmetic ref, const Vector& vect) {
...
void test_scalar_product(const reference_arithmetic ref, const Matrice& mat1, const Matrice& mat2) {
  bool stupid_scalar = ref.scalar_product(mat1, mat2);

  assert((mat1 % mat2) == stupid_scalar);
}

void test_scalar_product(const reference_arithmetic ref, const Vector& vect1, const Vector& vect2) {

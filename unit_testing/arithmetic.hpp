...
void test_multiplication(reference_arithmetic ref, const Matrice mat1, const Matrice mat2) {
  Matrice stupid_product = ref.multiplication(mat1, mat2);

  assert(ref.equal(mat1 * mat2, stupid_product));
}

void test_multiplication(reference_arithmetic ref, const Matrice mat, const Vector vect) {
...
void test_addition(reference_arithmetic ref, const Matrice mat1, const Matrice mat2) {
  Matrice stupid_add = ref.addition(mat1, mat2);

  assert(ref.equal(mat1 ^ mat2, stupid_add));
}

void test_addition(reference_arithmetic ref, const Matrice mat, bool bit) {
...
void test_bitwise_multiplication(reference_arithmetic ref, const Matrice mat1, const Matrice mat2) {
  Matrice stupid_mul = ref.bitwise_multiplication(mat1, mat2);

  assert(ref.equal(mat1 & mat2, stupid_mul));
}

void test_bitwise_multiplication(reference_arithmetic ref, const Matrice mat, bool bit) {
...
void test_negation(reference_arithmetic ref, const Matrice mat) {
...
void test_scalar_product(reference_arithmetic ref, const Matrice mat1, const Matrice mat2) {

...
void test_self_multiplication(reference_arithmetic ref, Matrice mat1, const Matrice mat2) {
...
void test_self_multiplication(reference_arithmetic ref, const Matrice mat, Vector vect) {
...
void test_self_addition(reference_arithmetic ref, Matrice mat1, const Matrice mat2) {
...
void test_self_addition(reference_arithmetic ref, Matrice mat, bool bit) {
...
void test_self_addition(reference_arithmetic ref, Vector vect1, const Vector vect2) {
  Vector stupid_add = ref.addition(vect1, vect2);
  vect1 ^= vect2;

  assert(ref.equal(vect1, stupid_add));
}
void test_self_addition(reference_arithmetic ref, Vector vect, bool bit) {
...
void test_self_bitwise_multiplication(reference_arithmetic ref, Matrice mat1, const Matrice mat2) {
...
void test_self_bitwise_multiplication(reference_arithmetic ref, Matrice mat, bool bit) {
...
void test_self_bitwise_multiplication(reference_arithmetic ref, Vector vect1, const Vector vect2) {
  Vector stupid_mul = ref.bitwise_multiplication(vect1, vect2);
  vect1 &= vect2;

  assert(ref.equal(vect1, stupid_mul));
}
void test_self_bitwise_multiplication(reference_arithmetic ref, Vector vect, bool bit) {
